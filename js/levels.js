...
window.levels = [
  {
    ...
    level: [
      ...
      'XOORTOOOXXOOROOOOOOOOOXXRX',
      'XXXOXXXOOOOXXXOXXOXOOOXOXX',
      'XOXMXOOOXXOOOOOOXOXXXOOOXX',
      'XOXXXOXXOOOXMXOOOOFTOOOXXX',
      'XOOOXOXXOXOOOOFXXXOXXXOOOX',
      'XXXOOOOXOXOXMKOXODOOXOOXOX',
      'XOOXXOXMOXOXPXOXOMXOXOXXMX',
      'XMROOOOOTOOXXXOOOOOOXOOXOX',
      'XOOXXOOXXXOOOOOXOXOXXXOOTX',
      'XXXOOOOOOOOOMOXXOOOOOOOOXX',
      'XOOXXOXOXXXOOOOOOOXXXOXOOX',
      'XOOOXOXOTXOOOOXXXOXHXOXXOX',
      'XXOXXOXOOXOXOXMOXOOOOOXXOX',
      'XOROOOOOOOOXOXOOROOOOOOXMX',
      'XXXXXXXXXXXXXXXXXXXXXXXXXX'
    ]
  },
  {
